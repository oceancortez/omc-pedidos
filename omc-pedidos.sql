...
CREATE TABLE `omc`.`cliente` (
  ...
  `DATCADCLI` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `DATULTALTCLI` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`CODCLI`))
ENGINE = InnoDB
...
CREATE TABLE `omc`.`produto` (
  ...
  `VLRPRD` DECIMAL(10,4) DEFAULT 0,
  `DATCADPRD` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `DATULTALTPRD` TIMESTAMP NULL  DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`CODPRD`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
